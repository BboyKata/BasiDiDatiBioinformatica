...
\textbf{Esercizio semplice:} uno zoo vuole creare la base di dati per memorizzare gli animali che ospita. Ogni animale ha un codice, un nome, l'età e la specie di appartenenza. Ogni specie viene collocata in un settore dello zoo. I settori sono caratterizzati dalla posizione all'interno dello zoo e da un nome. 

Data una relazione ternaria E1 - R - E2,E3. Se r1 non ha attributi, corrisponde a E1 - R1 - E3 - R1 - E2
...
A seguito di una ristrutturazione, lo schema ER ristrutturato NON è più uno schema ER propriamente detto. La ristrutturazione di un ER consiste nelle seguente fasi:
...
\begin{esempio}
	...
	\end{figure}
\end{esempio} 
inserisci digressione sul perché lasciarlo e perché no
\begin{esempio}
	\begin{figure}
		\centering
