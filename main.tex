...
Ad esempio, se abbiamo la relazione che rappresenta
\begin{figure}[h!]
	\centering
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{er2.pdf}
\end{figure}
...
Ad esempio se ho un'entità "Persona" che ha come attributi \textit{Nome, Cognome, CF, Indirizzo}, o se ho sempre un'entità "Persona" che ha come attributi \textit{Nome, Cognome, CF, Via, Civico, Città}. Oppure 

\begin{esempio}
	Studenti, corsi che seguono, città dove risiedono e studiano. Si vogliono rappresentare anche gli esami sostenuti dagli studenti. Studente è rappresentato da Matricola, Cognome, Nome, DataNascita. Corso ha codice, titolo e numcrediti. Le città hanno un nome ed un numero di abitanti, ed una regione di appartenenza. Degli esami memorizziamo il voto e la data in cui gli studenti superano l'esame. 
\end{esempio}
...
\textbf{Cardinalità:}\begin{itemize}
	...
	\begin{esempio}
		Inserisci schema impiegato Incarico, in cui dico che all'impiegato posso assegnare \textit{minimo} un incarico, \textit{massimo} 3 incarichi. Mentre, dico, che un incarico può \textit{non essere assegnato a nessuno}, oppure al massimo assegnato a 10 impiegati.
	\end{esempio}
	...
	Con riferimento alle cardinalità massime, abbiamo dei tipi di relazione: \sitemize{\item \textbf{Relazione UNO a UNO}: fai un ER ORDINE (0,1) - <Vendita> - (1,1) FATTURA 
	\item \textbf{Relazione UNO a MOLTI} ER con PERSONA (1,1) - <RESIDENZA> (0,n) - Città
	\item \textbf{Relazione MOLTI a MOLTI}
	Fai un ER TURISTA (1,n) Prenotazione (0,n) VIAGGIO
	}
	\item Di attributo
\end{itemize}
\textbf{Identificatore:}\begin{itemize}
	\item Interno
	\item Esterno
\end{itemize}
