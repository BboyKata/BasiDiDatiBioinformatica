...
\textbf{INSERISCI DISCLAIMER SULL'ORDINE DEGLI OPERANDI}

\textbf{Esempio:} visualizzare la città e il numero di studenti provenienti da quella città solo se gli studenti provenienti da quella città sono almeno 2.
\begin{lstlisting}[style=sqlstyle]
SELECT Citta, COUNT(*) as NStud
FROM STUDENTE
GROUP BY Citta
...
\textbf{ESEMPIO: trovare i cognomi e le città degli studenti maschi}
\begin{lstlisting}[style=sqlstyle]
SELECT Cognome
FROM STUDENTE
WHERE Genere = 'M'
...
\textbf{ESEMPIO 2: Trovare cognome e città di docenti e studenti}
\begin{lstlisting}[style=sqlstyle]
...
\textbf{ESEMPIO 3: trovare i cognomi degli studenti che sono anche città}
\begin{lstlisting}[style=sqlstyle]
SELECT Cognome 
FROM Studente
	INTERSECT
