...
\mybox{\emph{!Domanda di Esame!} \textit{quando una tabella rappresenta una relazione nel modello relazionale dei dati?} \textit{(per i posteri, 1 Forma Normale)}
	\begin{itemize}
...
Tabella Interna = \textbf{Tabella Slave}
Tabella Esterna = \textbf{Tabella Master}
\begin{itemize}
...
\textbf{Modificazioni tabella interna per cancellazione attributo riferito}
\begin{itemize}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{er10.png}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\linewidth]{er11}
	\label{fig:er11}
\end{figure}

\newpage
\textbf{Esercizio 5:}
Si richiede di progettare la base di dati per una catena di supermercati. Ogni supermercato è identificato da
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1\linewidth]{er12}
	\label{fig:er12}
\end{figure}
